<?php /*a:4:{s:56:"C:\site\cms\application\manager\view\category\index.html";i:1529697112;s:48:"C:\site\cms\application\manager\view\layout.html";i:1529787075;s:45:"C:\site\cms\application\manager\view\nav.html";i:1529738175;s:48:"C:\site\cms\application\manager\view\footer.html";i:1529279786;}*/ ?>
<!doctype html>
<html lang="zh_CN">
<head>
    <meta charset="utf-8">
...
<div class="container">
    <div class="row">
        <div class="w-100">
            <a href="<?php echo url('_categoryEdit',['parent'=>$parent['id'],'id'=>0]); ?>" class="btn btn-info rounded-0">新增栏目</a>
            <?php if($parent['id']): ?>
            <a href="<?php echo url('_category',['parent'=>$parent['parent']]); ?>" class="btn btn-info rounded-0"><?php echo htmlentities($parent['cname']); ?></a>
            <?php endif; ?>
        </div>
        <div class="w-100">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('_categoryEdit',['id'=>$item['id'],'parent'=>$parent['id']]); ?>" class="btn btn-sm btn-outline-secondary rounded-0">修改</a>
