<?php /*a:4:{s:55:"C:\site\cms\application\manager\view\category\edit.html";i:1529700327;s:48:"C:\site\cms\application\manager\view\layout.html";i:1529787075;s:45:"C:\site\cms\application\manager\view\nav.html";i:1529738175;s:48:"C:\site\cms\application\manager\view\footer.html";i:1529279786;}*/ ?>
<!doctype html>
<html lang="zh_CN">
<head>
    <meta charset="utf-8">
...
<div class="container">
    <div class="row">
        <form action="" id="cat" class="w-50">
            ...
            <div class="form-group">
                <?php if($data['id']): ?>
                <a href="<?php echo url('_category_update'); ?>" class="btn btn-dark" id="send">更新</a>
                <?php else: ?>
                <a href="<?php echo url('_category_save'); ?>" class="btn btn-dark" id="send">保存</a>
                <?php endif; ?>
            </div>
